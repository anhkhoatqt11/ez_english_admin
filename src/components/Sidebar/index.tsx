      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image
            ...
            priority
          ></Image>
          <p className="text-white">EzEnglish</p>
        </Link>
 ...
 */}
              ...
              {/* <li>
                <Link
                  href="/tests"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("tests") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/practice"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("practice") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <Pencil size={18} />
